...
// const friendsName = "Sammy"

// const greeting = "Hello, Ron";

// const ezGreeting = "Hello " + myName + " and " + friendsName; //concatination

// const greeting = `Hi, ${myName} and ${friendsName}.`  //string interpolation uses backticks
...
// const madLib = `I like to ${verb} with my ${noun} when I am ${adj}.`;
...
// peopleOnZoom.pop () // removes item at last index

// peopleOnZoom.length // counts items in array
